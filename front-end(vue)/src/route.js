...
const router = new VueRouter({
    ...
    routes: [
      ...
      { path: '/main', component: MainPage, meta:{authRequired: true},
        beforeEnter:(function (MainPage, Loginpage, next) {
          if (MainPage.matched.some(function(routeInfo) {
            return routeInfo.meta.authRequired;
          })){
            console.log("login please!")
          } else {
            console.log("routing success : '" + MainPage.path + "'");
            next();
          }
        })},
